# Projet.LINUX
Projet prise en main Linux Semestre 1 MIT Université d'Antananarivo.
Gamification des commandes de base Linux. MasterLin est un jeu de quiz interactif en bash pur, qui s'exécute dans le terminal Linux à travers trois modules: gestion de fichiers, traitement de texte, droits et permissions (chacun découpé en trois niveaux de difficulté débloqués progressivement selon les points accumulés).
